...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // File Browser, Recents, Web (SkyPortal), File transfer, Settings
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS), tr(STR_PORTAL),
...
void HomeActivity::onPortalOpen() { activityManager.goToPortal(); }
