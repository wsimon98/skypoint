...
int HomeActivity::getMenuItemCount() const {
  int count = 4;  // File Browser, Recents, Network, Settings
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS), tr(STR_NETWORK),
...
void HomeActivity::onNetworkOpen() { activityManager.goToNetworkMenu(); }
