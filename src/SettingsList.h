...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        // SkyPoint: clock/weather/streak overlay on the sleep screen
        SettingInfo::Enum(StrId::STR_SLEEP_GLANCE, &CrossPointSettings::sleepGlance,
                          {StrId::STR_STATE_OFF, StrId::STR_STATE_ON}, "sleepGlance", StrId::STR_CAT_DISPLAY),
        ...
        SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                          {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED,
                           StrId::STR_THEME_ROUNDEDRAFF, StrId::STR_THEME_SKYPOINT},
