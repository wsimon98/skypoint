...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::SKYPOINT:
      LOG_DBG("UI", "Using SkyPoint theme");
      currentTheme = std::make_unique<SkyPointTheme>();
      currentMetrics = &SkyPointMetrics::values;
      break;
  }
}
